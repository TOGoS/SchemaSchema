...
public class Application
{
	...
	public static final Predicate HAS_DB_TABLE     = definePredicate(NS, "has an associated database table", Types.BOOLEAN, "indicates that there should be a database table with rows corresponding to instances of this class");
	public static final Predicate HAS_REST_SERVICE = definePredicate(NS, "has an associated rest service"  , Types.BOOLEAN, "indicates that the this class's instances should be exposed via services");
