...
public class Application
{
	...
	public static final Predicate HAS_DB_COLUMN    = definePredicate(NS, "has a database column", Types.BOOLEAN, "indicates that there should be a database column corresponding to this field");
